...
/**
 * What to render for an asset: the optimized variant for an image, the poster
 * for a video, the origin as the fallback for both.
 *
...
export const mediaSrc = (asset: MediaAsset): string =>
  asset.kind === "video"
    ...
    : (asset.optimizedUrl ?? asset.originUrl);
